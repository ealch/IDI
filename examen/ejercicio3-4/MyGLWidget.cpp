...
MyGLWidget::MyGLWidget (QGLFormat &f, QWidget* parent) : QGLWidget(f, parent) {
  ...
  cajaContenedoraEscena.max = glm::vec3(1.0f, 4.0f, 1.0f);
...
void MyGLWidget::modelTransformPatricio2() {
  glm::mat4 TG(1.f);  // Matriu de transformació
  TG = glm::translate(TG, glm::vec3(0.0f, 2.0f, 0.0f));
  TG = glm::scale(TG, glm::vec3(escalaPatr, escalaPatr, escalaPatr));
...
void MyGLWidget::modelTransformPatricio3() {
  ...
  TG = glm::translate(TG, glm::vec3(1.0, -0.375, 0.0));
  TG = glm::scale(TG, glm::vec3(escalaPatrPeq, escalaPatrPeq, escalaPatrPeq));
  TG = glm::translate(TG, -centrePatr);
  glUniformMatrix4fv (transLoc, 1, GL_FALSE, &TG[0][0]);
}
