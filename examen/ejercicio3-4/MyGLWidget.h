...
class MyGLWidget : public QGLWidget {
  ...
  private:
    ...
    // VAO i VBO names
    GLuint VAO_Patr1, VAO_Patr2, VAO_Patr3, VBO_PatrPos, VBO_PatrNorm, VBO_PatrMatamb, VBO_PatrMatdiff, VBO_PatrMatspec, VBO_PatrMatshin;
    ...
    GLuint transLoc, projLoc, viewLoc, focusLoc, colorLoc, llumAmbLoc;
    GLuint vertexLoc, normalLoc, matambLoc, matdiffLoc, matspecLoc, matshinLoc;
    
    Model patr;
    // paràmetres calculats a partir de la capsa contenidora del model
    glm::vec3 centrePatr;
    float escalaPatr, escalaPatrPeq;
